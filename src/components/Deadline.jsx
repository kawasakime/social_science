      ...
      <div className="wrapper">
        ...
        <div className="container">
          ...
          <div className="right-side">
            <h4>до 7 октября 2026 года</h4>
            <p>
              Выслать тезисы (требования по оформлению в Информационном письме) для включения в сборник конференции (
              <b>РИНЦ</b>). Материалы можно отправить на почту <span className="red">conf.science-uriu@ranepa.ru</span>{" "}
            ...
            <h4>15 – 16 октября 2026 года</h4>
            <p>Мероприятия конференции</p>
            <h4>22-23 октября 2026 года</h4>
            <p>Рассылка дипломов участников</p>
            <h4>Декабрь 2026 года</h4>
            <p>
