      ...
      <div className="wrapper">
        ...
        <div className="container">
          ...
          <div className="right-side">
            <h4>до 10 октября 2023 года</h4>
            <p>
              Выслать тезисы (требования по оформлению в Информационном письме)
              для включения в сборник конференции (<b>РИНЦ</b>). Материалы можно
              отправить на почту{" "}
              <span className="red">udolgashova@uriu.ranepa.ru</span>{" "}
              регистрация будет доступна в августе 2023 года.
            </p>
            <h4>19 – 20 октября 2023 года</h4>
            <p>Мероприятия конференции</p>
            <h4>25 октября 2023 года</h4>
            <p>Рассылка дипломов участников</p>
            <h4>25 ноября 2023 года</h4>
            <p>
              Выпуск сборника материалов Конференции и размещение его в научной
              электронной библиотеке <b>(www.elibrary.ru)</b> с индексацией в
              наукометрической базе РИНЦ (Российский Индекс Научного
              Цитирования)
            </p>
          </div>
        </div>
